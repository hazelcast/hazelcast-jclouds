...
public class ComputeServiceBuilderInvalidConfigTest extends HazelcastTestSupport {
    ...
    public void test_invalid_config_when_no_provider_is_set() {
    ...
    public void test_invalid_config_when_credential_and_credential_path_set_together() {
    ...
    public void test_invalid_config_when_both_IAM_and_credential_set() {
    ...
    @Test(expected = InvalidConfigurationException.class)
    public void test_invalid_config_when_IAM_role_is_configured_with_nonEc2_Provider() {
    ...
    @Test(expected = InvalidConfigurationException.class)
    public void test_invalid_config_when_tag_keys_and_values_have_different_sizes() {
        String propertiesUnderTest = "<property name=\"provider\">aws-ec2</property>"
                + "<property name=\"identity\">test</property>"
                + "<property name=\"credential\">test</property>"
    ...
    @Test(expected = InvalidConfigurationException.class)
    public void test_invalid_config_when_port_config_exceed_max_value() {
        String propertiesUnderTest = "<property name=\"provider\">aws-ec2</property>"
                + "<property name=\"identity\">test</property>"
                + "<property name=\"credential\">test</property>"
    ...
    @Test(expected = InvalidConfigurationException.class)
    public void test_invalid_config_when_port_config_smaller_than_min_value() {
        String propertiesUnderTest = "<property name=\"provider\">aws-ec2</property>"
                + "<property name=\"identity\">test</property>"
                + "<property name=\"credential\">test</property>"
    ...
    @Test(expected = InvalidConfigurationException.class)
    public void test_getCredentialFromFile_when_IOException() {
    ...
    @Test(expected = InvalidConfigurationException.class)
    public void test_InvalidCloudProvider() {
        ComputeServiceBuilder builder = new ComputeServiceBuilder(new HashMap<String, Comparable>());
